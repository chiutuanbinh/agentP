...
TESTING = Skill(
    ...
    prompt_section="""\
## Testing
- Read existing tests before writing new ones — follow the same patterns, fixtures, and assertion style
...
- For QA reviews: check for missing edge cases, flaky async tests, hardcoded values, missing teardown
""",
)
